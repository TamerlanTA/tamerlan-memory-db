...
- Creative direction: premium AI explainer short, hybrid motion-design scenes, not generic website sections or app-only screens.
...
## Blockers
- Figma Starter-plan MCP tool-call limit prevented direct creation of scene frames/components in Figma.
