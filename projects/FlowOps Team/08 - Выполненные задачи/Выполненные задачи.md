...
- **Заготовка под CRM** — подготовлена Airtable-ready структура CRM: таблицы, поля, views, seed records и план первых автоматизаций.

## Пока не считаем завершенным
- Live-импорт и тест Upwork Radar в n8n.
- Создание/проверка реальной Airtable базы `FlowOps CRM`.
